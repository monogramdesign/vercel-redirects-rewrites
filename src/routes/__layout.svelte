	...
	<nav class="flex gap-x-2">
		<a
			...
			class={`font-mono py-1 px-4 rounded ${
				$page.routeId === '' ? 'bg-blue-50 text-blue-600' : 'bg-gray-50 text-gray-600'
			}`}
		>
			&#x2f;
		</a>
		<a
			href="/home"
			class={`font-mono py-1 px-4 rounded ${
				$page.routeId === 'home' ? 'bg-blue-50 text-blue-600' : 'bg-gray-50 text-gray-600'
			}`}
		>
			/home
		</a>
		<a
			href="/dashboard"
			class={`font-mono py-1 px-4 rounded ${
				$page.routeId === 'dashboard' ? 'bg-blue-50 text-blue-600' : 'bg-gray-50 text-gray-600'
			}`}
		>
			/dashboard
		</a>
...
<main class="container">
	...
	{#if `/${$page.routeId}` !== $page.url.pathname}
		<div class="rounded-lg border-2 border-green-100 text-green-700 bg-green-50 text-sm mb-8 p-4">
...
>
	...
	<div class="flex items-center divide-x not-prose">
		<a
			...
			class="flex px-4"
		>
			<svg xmlns="http://www.w3.org/2000/svg" class="w-4 mr-2" viewBox="0 0 496 512"
